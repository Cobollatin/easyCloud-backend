...
import userservice.filter.CustomAuthenticationFilter;
...
//        CustomAuthenticationFilter customAuthenticationFilter = new CustomAuthenticationFilter(authenticationManagerBean(),  jwtCenter);
